...
namespace LlamasWhalesAndDodosOhMy
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("There's been a huge increase in dodo population via cloning!");
            dodos += 100;
            llamas += 81; //2. changed assgined variable values so that "I don't know how, but the llamas..." condition would display
