...
namespace MethodToMadness
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n ? Lewis Carroll, Alice in Wonderland"); // As a reminder, does /n mean new line? new paragraph?
        }

        static void EatMe()
        {
            Console.WriteLine("'But I don't want to go among made people,' Alice remarked.");
